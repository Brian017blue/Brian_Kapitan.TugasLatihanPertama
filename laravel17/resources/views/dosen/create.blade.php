...
<body>
      ...
      <header class="bg-black text-white">    
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <h1 class="text-center text-3xl font-bold tracking-tight">Tambah Data</p> Dosen</h1>
        </div>
      </header>       
        ...
        <form action="{{ route('dosen.store') }}" method="POST">
            ...
            <div class="">
              ...
              <div class="">
                ...
                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="kode_dosen" name="kode_dosen" type="text" required>
              </div>
              <div class="">
                <label class="block text-sm text-gray-600" for="name">NIP</label>
                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="nip" name="nip" type="text" required>
              </div>
              <div class="">
