...
<body>
      ...
      <header class="bg-black text-white">    
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <h1 class="text-center text-3xl font-bold tracking-tight">Tambah Data</p> Kelas</h1>
        </div>
      </header>       
      ...
      <div class=" item-centerleading-loose">
        <form action="{{ route('kelas.store') }}" method="POST">
            ...
            <div class="">
                ...
                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="id" name="id" type="text" required>
              </div>
              <div class="">
              ...
              <div class="">
                <label class="block text-sm text-gray-600" for="jumlah">JUMLAH</label>
                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="jumlah" name="jumlah" type="number" required>
            </div>
